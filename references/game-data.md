...
| Nation | Alliance | Capital | Max Orders | Special Rules |
|---|---|---|---|---|
| China | Allied | — (Peiping is a capital for medals) | 6 | No Oil, no trade, land only, special mobilization |
| British Commonwealth | Allied | Great Britain | 9 | Shares territories with USA |
| Soviet Union | Allied | Moscow | 9 | Stalin Doctrine, Soviet-Japanese NAP |
| United States | Allied | Eastern United States | 9 | — |
| Germany | Axis | Greater Germany | 9 | — |
| Italy | Axis | Italy | 6 | — |
| Imperial Japan | Axis | Japan | 9 | Soviet-Japanese NAP |

---

## Resources

| Resource | Color | Peg Color | Trade Rate (blocks of) |
|---|---|---|---|
| Oil | Red icon | Red peg | 2 |
| Iron | Blue icon | Blue peg | 3 |
| OSR | Yellow icon | Yellow peg | 5 |

Trade is Global War only, 1 trade per nation per round, during Phase 7 Step 2.

---

## Unit Costs & Casualty Points
...
| Battleship | 15 |
| Carrier Fighter | 16 |
| Multipliers (×3) | 6 Land, 6 Air, 6 Naval |

---

## Dice (d12)

| Color | Faces | Probability |
|---|---|---|
| Yellow | 4 | 33.3% |
| Blue | 3 | 25.0% |
| Green | 2 | 16.7% |
| Red | 1 | 8.3% |
| Black (wild) | 1 | 8.3% |
| White (conditional) | 1 | 8.3% |

Hit assignment order: Yellow → Blue → Green → Red → Black → White.

---

## Homeland Status Zones

| Zone | Name | Penalty |
|---|---|---|
| White | Acceptable Stress | None (start) |
| Blue | Labor & Civil Unrest | Pay 3 Resources (any mix) |
| Yellow | Dysfunctional Rails & Ports | Nation's Rails unusable, no sea trade, no Port Advantage |
| Orange | Disrupted Supply Lines | 3 fewer written orders |
| Red | Economic Collapse | No new Resource income |
| Gray | Mass Desertion | Remove Units from map = current stress (excl. units under construction & Carrier Fighters). Stress NOT reduced. |

Penalties are **cumulative** and **recurring** each round.

---

## Casualty Points → Stress Conversion
...
## Stress Thresholds by Scenario

### Global War (gold side)
...
### War in Europe (silver side, "Europe")
...
### War in the Pacific (silver side, "Pacific")
...
### North Africa (silver side, "Europe")
...
### Eastern Front (gold side, "Eastern Front")
...
## Quick Play Casualty Points (simplified)
...
Conversion: **5 CP → 1 Stress** (drop remainder). Max 6 stress from casualties per round.

---

## Quick Play Production Values by Scenario

| Nation | Global | Europe | Pacific | N. Africa | E. Front |
|---|---|---|---|---|---|
| China | 3 | — | 3 | — | — |
| British Commonwealth | 7 | 4 | 3 | 3 | — |
| Soviet Union | 5 | 5 | — | — | 5 |
| United States | 10 | 5 | 5 | 5 | — |
| Germany | 8 | 8 | — | 3 | 5 |
| Italy | 4 | 4 | — | 4 | — |
| Imperial Japan | 6 | — | 6 | — | — |
...
## Stress Sources (non-casualty)

| Event | Stress |
|---|---|
| Lose a territory | SV of the territory |
| Break Soviet-Japanese NAP | 6 (breaking party) |
| Invade a Neutral (first time) | 1 |
| No Units and no Territories | Advance 1 Zone |
...
| Event | Medals |
|---|---|
| Capture non-capital territory | 1 |
| Capture capital territory | 3 |
| Capture Neutral | 0 |
...
| Passage | Sea Regions | Requirement |
|---|---|---|
| Panama Canal | A-12 ↔ P-7 | Control Central America |
| Suez Canal | M-3 ↔ M-5 | Control Egypt |
| Danish Straits | A-5 ↔ A-6 | Control Denmark AND Norway |
| Gibraltar | A-15 ↔ M-1 | Control Gibraltar |
| Malacca | I-9 ↔ P-15 | Control Malaya |
| Turkish Straits | M-3 ↔ M-4 | Control Turkey (initially Neutral) |

Air Units are unaffected by Narrow Sea Passages.

---

## Bomb Damage Repair

Cost: **9 Iron** per Bomb Token removed. Max 1 per round. Announced during Phase 7, after trading but before purchases revealed.

---

## Victory Conditions by Scenario

| Scenario | Axis Wins | Allied Wins |
|---|---|---|
| Global War | Control 2 of 3: E. US, Great Britain, Moscow | Control both: Greater Germany, Japan |
| War in Europe | Control any 1 of: Great Britain, Moscow, E. US | Control Greater Germany |
